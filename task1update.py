...
class BlackAntColony:
    """Класс описывает колонию красных муравьев. Принципиальное отличие данного класса от предыдущего заключается в том, что у черных муравьев нет зависимости от темпепратуры"""
